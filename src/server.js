...
const { getBookingWithSuppliers } = require('./controllers/core/getBookingSuppliers');
const saveBookingWithSuppliers = require('./controllers/core/saveAceFeed');
const SupplierPaymentTerms = require('./controllers/core/addPaymentTerms');
...
const GetPaymentSchedule = require('./controllers/core/getPaymentSchedule');
const processDocument = require('./controllers/core/documentParser');
const GetAllInvoiceData = require('./controllers/core/getAllinvoices');
const fetchLatestInvoiceMiddleware = require('./middleware/imap');
const enhancedProcessDocument = require('./controllers/core/enchancedProcessDoc');
...
app.get("/api/getInvoices",GetAllInvoiceData);
...
app.get("/api/getpaymentSchedule",GetPaymentSchedule);
app.post("/api/insertInvoiceData", fetchLatestInvoiceMiddleware,enhancedProcessDocument);
